...
// Không cần $conn->close() ở đây nếu các file khác còn dùng
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    <title>Admin Login | aespa Fanpage</title>
...
<body>
    ...
    <div class="container login-container">
        <div class="login-card">
            <img src="images/favicon.png" alt="aespa Logo" class="login-logo">
            
            <h1>Admin SYNK</h1>
            <p class="login-subtitle">Enter the FLAT to manage content</p>
            ...
            <div class="back-to-site">
                <a href="index.php">Quay về trang Fanpage</a>
            </div>
        </div>
    </div>
</body>
