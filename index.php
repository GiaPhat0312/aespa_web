            ...
            <div class="group-info">
                ...
                <div class="social-links">
                    ...
                    <a href="https://www.facebook.com/aespa.official" target="_blank" rel="noopener noreferrer" class="social-icon facebook" title="aespa on Facebook">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path d="M22,12A10,10 0 1,0 12,22A10,10 0 0,0 22,12M12,2A10,10 0 0,0 2,12C2,17.52 6.48,22 12,22C17.52,22 22,17.52 22,12A10,10 0 0,0 12,2M13,12H15V17H13V12H11V10H13V8.5C13,7.12 14.12,6 15.5,6H17V8H15.5C15.22,8 15,8.22 15,8.5V10H17L16.5,12H15V17H13V12Z" />
                        </svg>
                    </a>
                </div>
            </div>
