...
<header class="main-header">
    ...
    <nav class="main-nav" id="mainNav">
        <ul>
            <li>
                <a href="index.php" class="nav-link <?= is_active(['index.php', 'member.php']) ?>">
            ...
            <li>
                <a href="discography.php" class="nav-link <?= is_active(['discography.php', 'album.php']) ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <li>
                <a href="news.php" class="nav-link <?= is_active(['news.php', 'post.php']) ?>"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <li>
                <a href="merch.php" class="nav-link <?= is_active(['merch.php']) ?>">
            ...
            <li>
                <a href="lore.php" class="nav-link <?= is_active(['lore.php', 'lore_entry.php']) ?>"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
                        <title>heart</title>
